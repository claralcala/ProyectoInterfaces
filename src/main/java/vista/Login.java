...
public class Login extends JFrame {
	...
	public Login() {
		...
		/**
		 * Verificar si el campo de contraseña de usuario contiene el texto predeterminado.
		 */
		...
		/**
		 * Accion de salir y entrar cambia el color del panel.ç
		 * Accion de click hace consulta con la base de datos.
		 */
		...
		lblEntrar.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR)); // cursor que cuando pasa por encima cambia
																				// al icono de la mano en el raton.
		...
		lblX.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR)); // cursor que cuando pasa por encima cambia al
																		// icono de la mano en el raton.
		...
		lbl_.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));// icono de la mano en el raton.
