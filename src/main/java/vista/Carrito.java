...
//	}
	...
	public Carrito(final int id_usuario) {
        ...
        for (Producto carrito : carrito) {
    		...
    		btnDelete.addMouseListener(new MouseAdapter() {
    			...
    			public void mouseClicked(MouseEvent e) {
    		        ...
    		        Carrito nuevaVentanaCarrito = new Carrito(id_usuario); // Crea una nueva instancia de la ventana del carrito
		...
		textField.setBounds(88, 15, 166, 19);
		...
		searchLabel.setBounds(259, 10, 30, 30);
